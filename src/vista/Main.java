    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (op1 == 1) {
                ...
                System.out.println("Ingrese la carrera del estudiante que desea eliminar:");
                    String carrera = es.next();
                    EstudianteControlador pc = new EstudianteControlador();
                    pc.eliminarEstudiantes(carrera);
            }else if(op1==6){
